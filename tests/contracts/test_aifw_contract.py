...
class TestLLMRouterContract:
    ...
    def test_completion_accepts_quality_level_not_quality(self):
        ...
        assert "quality_level" in params, \
            "LLMRouter.completion should accept 'quality_level' parameter"
...
class TestLLMRouterAdapterMapping:
    ...
    def test_adapter_maps_quality_to_quality_level(self):
        ...
        with patch.object(adapter, '_router') as mock_router:
            ...
            assert "quality_level" in call_kwargs, \
                "Adapter should map 'quality' to 'quality_level'"
            assert call_kwargs["quality_level"] == 2
            assert "quality" not in call_kwargs, \
                "Adapter should NOT pass 'quality' to LLMRouter"
    ...
    def test_adapter_filters_unknown_kwargs(self):
        ...
        with patch.object(adapter, '_router') as mock_router:
            ...
            assert "unknown_param" not in call_kwargs, \
                "Adapter should filter unknown kwargs"

...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--model", default="gpt-4o-mini", help="LLM-Modell-Name")
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            self.stdout.write(f"  ~ Provider aktualisiert: {provider_name}")
        ...
        try:
            ...
            self.stdout.write(f"  ~ Model aktualisiert: {model_name}")
            ...
            if broken:
                ...
                model_obj = broken
                self.stdout.write(self.style.WARNING(f"  ~ Defekten Model-Eintrag repariert: '{model_name}'"))
            else:
            ...
            try:
                ...
                if created:
                    ...
                    if force:
                        ...
                        obj.save(update_fields=["default_model", "is_active", "name", "max_tokens"])
                    else:
                        obj.save(update_fields=["default_model", "is_active"])
                    updated_count += 1
                    self.stdout.write(f"  ~ {code} (Modell gesetzt)")

...
urlpatterns = [
    ...
    path("studio/<uuid:pk>/idee/<uuid:idea_pk>/verfeinern/", views_creative.CreativeRefineView.as_view(), name="creative_refine"),
    path("studio/<uuid:pk>/idee/<uuid:idea_pk>/bewerten/", views_creative.CreativeRateView.as_view(), name="creative_rate"),
    path("studio/<uuid:pk>/idee/<uuid:idea_pk>/premise/", views_creative.CreativePremiseView.as_view(), name="creative_premise"),
    path("studio/<uuid:pk>/projekt-anlegen/", views_creative.CreativeCreateProjectView.as_view(), name="creative_create_project"),
